...
def run_interpreter(source: str) -> str:
...
def main() -> None:
    # CLI entry point.
    # Usage:
    #   python interpreter.py program.usql        -> interpret
    #   python interpreter.py --o program.usql    -> optimize
